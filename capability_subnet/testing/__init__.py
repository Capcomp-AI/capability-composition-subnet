...
same miniature pool. Two copies of these fixtures would drift, and a drifting
fixture makes the two suites test subtly different systems.
...
adapters, and almost nothing under test needs their size — the merge engine cares
about shapes and determinism, the comparator about numbers, the engine loop about
control flow. So these build a miniature pool with the same *structure* and a
