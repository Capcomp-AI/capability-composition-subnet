...
| [`lora-merger-engine`](https://github.com/Namikaze-bit/lora-merger-engine) | The evaluation engine that *runs* those rules: window loop, candidate serving, store, read-only API, operator configuration | The subnet operator only |
